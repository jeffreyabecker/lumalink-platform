...
#else
#error "httpadv::v1::util::span requires either a C++20 <span> or the compat/span.h (tcbrindle) implementation. Add src/compat/span.h or enable C++20 support."
