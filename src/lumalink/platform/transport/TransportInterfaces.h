...
namespace lumalink::platform::transport
{
    ...
    public:
        ...
        virtual std::size_t write(lumalink::platform::util::span<const std::uint8_t> buffer) = 0;
        ...
        virtual std::size_t read(lumalink::platform::util::span<std::uint8_t> buffer) = 0;
        virtual std::size_t peek(lumalink::platform::util::span<std::uint8_t> buffer) = 0;
